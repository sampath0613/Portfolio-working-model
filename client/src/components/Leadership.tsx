...
export default function Leadership() {
  const achievements = [
    ...
    },
    {
      ...
      details: ["Panel discussions", "Technical workshops", "Community engagement"]
    },
    {
      icon: Users,
  ...
  return (
    <section id="leadership" className="py-24 md:py-32 bg-card">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <Card className="mb-8 border-primary/20" data-testid="card-space-club">
          <CardHeader>
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <CardTitle className="text-2xl mb-2" data-testid="text-space-club-title">Space Club President</CardTitle>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="outline" data-testid="badge-timeline">5 months as President</Badge>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-foreground/80 font-body mb-4" data-testid="text-space-club-description">
